...
<?php
   ...
   $data = "http://whistleblower.ng/api/get_allwhistles.php?page=$page";
                    ...
                    ?>
                        ...
                        <div class="content">
                            ...
                            <p class="text-description text-gray"><?php 
                             ...
                             $substring = $substring."...";
                             echo $substring ?></p>
                            <p> <a href="javascript:void(0)"  id="<?php echo "id".$i ?>" class='btn btn-success '  onclick='remove_whistle(<?php echo "\" ".$json_response['articles'][$i]['postId']."\""; ?>,<?php echo "\" ".$user->logged_in_user()."\""; ?>)'>Remove </a></p>
                        </div>
                    </div>
              </div>
               ...
               <ul class="pagination">
                     <?php 
                      ...
                      ?>  
                          ...
                          <li <?php if($page == $b) echo 'active'; ?>> <a  href="approved_whistles.php?page=<?php echo $b; ?>"><?php echo $b; ?></a></li>
                         <?php
...
<script>
    function remove_whistle(reportId,admin){
