...
<?php
   ...
   $data = "http://127.0.0.1/whistleb/api/get_allwhistles.php?page=$page";
...
<?php
//
$data1 = "http://127.0.0.1/whistleb/api/get_whistlecategory.php?";
                    ...
                    <div class="col-md-4">
                        <div class="card card-blog">
                            ...
                            <a href='<?php echo "whistle.php?postId=$postId"; ?>' class="header">
                                ...
                                ?>
                               <div style="color:red; margin:5px;"> <?php echo $label; ?></div>
               ...
               <ul class="pagination">
                     <?php 
                      ...
                      ?>  
                          ...
                          <li <?php if($page == $b) echo 'active'; ?>> <a  href="view_all_whistle.php?page=<?php echo $b; ?>"><button class="btn btn-danger"><?php echo $b; ?></button></a></li>
                         <?php
