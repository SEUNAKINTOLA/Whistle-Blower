                    ...
                    <form id="whistle">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control">
                             <input type="hidden" value="<?php echo htmlspecialchars($_SESSION['nickname']) ?>" name="nickname" id="nickname"  class="form-control">
                            ...
                            <div class="form-group"> <!-- State Button -->
                                ...
                                <?php
                                    ...
                                    $data = "http://127.0.0.1/whistleb/api/get_all_category.php";
                                ...
                                <?php
                                    for ($z = 0; $z <= $num; $z++) {
                                        if (!isset($json_response['data'][$x]))
                                            break;
                                ?>
                                            <option value="<?php echo $json_response['data'][$x]['id'] ?>"><?php echo $json_response['data'][$x]['name'] ?></option>
